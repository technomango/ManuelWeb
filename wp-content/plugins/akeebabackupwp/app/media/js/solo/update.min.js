...
akeeba.Update.startDownload=function(){akeeba.Update.setProgressBar(0,"downloadProgressBar");Piecon.setOptions({color:"#333333",background:"#e0e0e0",shadow:"#000000",fallback:"force"});document.getElementById("downloadProgressBarText").innerHTML="";var a={task:"downloader",json:JSON.stringify({frag:-1,totalSize:-1})};akeeba.System.doAjax(a,function(b){akeeba.Update.stepDownload(b)},null,!1)};
akeeba.Update.stepDownload=function(a){if(a.status){var b=0,c=0,d=0,e=-1;void 0!==a.totalSize&&(b=a.totalSize);void 0!==a.doneSize&&(c=a.doneSize);void 0!==a.percent&&(d=a.percent);void 0!==a.frag&&(e=a.frag);akeeba.Update.setProgressBar(d,"downloadProgressBar");document.getElementById("downloadProgressBarText").innerText=d.toFixed(1)+"%";a={task:"downloader",json:JSON.stringify({frag:e,totalSize:b,doneSize:c})};if(100>d)akeeba.System.doAjax(a,function(f){akeeba.Update.stepDownload(f)},null,!1);else{akeeba.Update.setProgressBar(100,
