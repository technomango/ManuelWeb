...
class UM_Verified_Users_API {
	...
	/**
	 * @return um_ext\um_verified_users\core\Verified_Users_Member_Directory()
	 */
	function member_directory() {
		if ( empty( UM()->classes['um_verified_users_member_directory'] ) ) {
			UM()->classes['um_verified_users_member_directory'] = new um_ext\um_verified_users\core\Verified_Users_Member_Directory();
		}
		return UM()->classes['um_verified_users_member_directory'];
	}
