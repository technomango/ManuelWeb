	...
	class Account {
		...
		function get_tabs() {
			...
			$tabs[200]['password'] = array(
				'icon'          => 'fas fa-lock',
				'title'         => __( 'Cambiar Contraseña', 'ultimate-member' ),
			...
			if ( um_user( 'can_delete_profile' ) || um_user( 'can_delete_everyone' ) ) {
				...
				$tabs[99999]['delete'] = array(
					...
					'title'         => __( 'Borrar Cuenta', 'ultimate-member' ),
					'submit_title'  => __( 'Borrar Cuenta', 'ultimate-member' ),
				);
		...
		function render_account_tab( $tab_id, $tab_data, $args ) {
			...
			if ( $output ) {
				...
				if ( ! empty ( $tab_data['with_header'] ) ) { ?>
					...
					<div class="um-account-heading uimob340-hide uimob500-hide"><div class="fusion-title title fusion-title-2 fusion-sep-none fusion-title-center fusion-title-highlight fusion-loop-off fusion-highlight-underline fusion-title-size-three" style="margin-top:30px;margin-right:0px;margin-bottom:40px;margin-left:0px" data-highlight="underline" data-animationoffset="top-into-view"><h3 class="title-heading-center fusion-responsive-typography-calculated" style="margin:0;line-height:1.3;font-size: 28px;font-weight: 300;font-family: 'Roboto';"><span class="fusion-highlighted-text-prefix"></span> <span class="fusion-highlighted-text-wrapper"><span class="fusion-highlighted-text"><i class="<?php echo esc_attr( $tab_data['icon'] ) ?> icon-titles-profile"></i><?php echo esc_html( $tab_data['title'] ); ?></span></span> <span class="fusion-highlighted-text-postfix"></span></h3></div></div>
