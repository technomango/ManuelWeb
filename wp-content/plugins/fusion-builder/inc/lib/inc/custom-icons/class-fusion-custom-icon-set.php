		...
		<div class="fusion-custom-icons-wrapper <?php echo esc_attr( $wrapper_class ); ?>">
			...
			<?php else : ?>
				...
				<div class="fusion-custom-icons-top-bar">
					...
					if ( $json_exists ) :
						?>
					<a href="<?php echo FUSION_ICONS_BASE_URL . $icon_set['icon_set_dir_name'] . '/selection.json'; ?>" id="fusion-custom-icons-json" target="_blank" data-title="<?php echo esc_attr( __( 'JSON', 'fusion-builder' ) ); ?>">
