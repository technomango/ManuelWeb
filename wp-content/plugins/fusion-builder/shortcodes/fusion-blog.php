		...
		class FusionSC_Blog extends Fusion_Element {
			...
			public static function get_element_extras() {
				...
				return [
					...
					'read_more_text'                    => apply_filters( 'avada_read_more_name', esc_attr__( 'Leer Más', 'fusion-builder' ) ),
					...
					'load_more_text'                    => apply_filters( 'avada_load_more_posts_name', esc_attr__( 'Cargar Más Artículos', 'fusion-builder' ) ),
			...
			public function render( $args, $content = '' ) {
				...
				if ( $this->args['load_more'] && 1 < $this->query->max_num_pages ) {
					$html .= '<button class="fusion-load-more-button fusion-blog-button fusion-clearfix">' . apply_filters( 'avada_load_more_posts_name', esc_attr__( 'Cargar Más Artículos', 'fusion-builder' ) ) . '</button>';
				}
			...
			public function read_more() {
				...
				if ( $this->args['meta_link'] ) {
					...
					if ( $this->args['meta_read'] ) {
						...
						$inner_content .= apply_filters( 'avada_read_more_name', esc_attr__( 'Leer Más', 'fusion-builder' ) );
						$inner_content .= '</a>';
						$inner_content .= '</div>';
			...
			[
				...
				'params'     => [
					...
					[
						...
						'default'     => 'category',
						'value'       => [
							'category' => esc_attr__( 'Categoría', 'fusion-builder' ),
					...
					[
						'type'        => 'multiple_select',
						'heading'     => esc_attr__( 'Categorías', 'fusion-builder' ),
						'placeholder' => esc_attr__( 'Categorías', 'fusion-builder' ),
