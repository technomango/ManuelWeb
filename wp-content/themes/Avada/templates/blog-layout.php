							...
							<div class="fusion-meta-info">
								<?php if ( $display_read_more ) : ?>
									...
									<div class="<?php echo esc_attr( $readmore_alignment ); ?>">
										<a href="<?php echo esc_url_raw( get_permalink() ); ?>" class="fusion-read-more"<?php echo $link_target; // phpcs:ignore WordPress.Security.EscapeOutput ?> aria-label="<?php esc_attr_e( 'Más en', 'Avada' ); ?> <?php the_title_attribute(); ?>">
											<?php echo esc_textarea( apply_filters( 'avada_blog_read_more_link', esc_attr__( 'Leer Más', 'Avada' ) ) ); ?>
										</a>
									</div>
								<?php endif; ?>
							...
							<?php if ( $display_read_more ) : ?>
								...
								<div class="fusion-alignright">
									<a href="<?php echo esc_url_raw( get_permalink() ); ?>" class="fusion-read-more"<?php echo $link_target; // phpcs:ignore WordPress.Security.EscapeOutput ?> aria-label="<?php esc_attr_e( 'More on', 'Avada' ); ?> <?php the_title_attribute(); ?>">
										<?php echo esc_textarea( apply_filters( 'avada_read_more_name', esc_attr__( 'Leer Más', 'Avada' ) ) ); ?>
									</a>
								</div>
							<?php endif; ?>
						</div>
