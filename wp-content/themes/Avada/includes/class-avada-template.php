				...
				<div class="comment-box">
					<div class="comment-author meta">
						...
						printf(
							...
							esc_attr__( '%1$s a las %2$s', 'Avada' ),
						...
						edit_comment_link( __( ' - Editar', 'Avada' ), '  ', '' );

						comment_reply_link(
							array_merge(
								$args,
								[
									'reply_text' => __( ' - Responder', 'Avada' ),
									'add_below'  => 'comment',
									'depth'      => $depth,
					...
					<div class="comment-text">
						<?php if ( '0' == $comment->comment_approved ) : // phpcs:ignore WordPress.PHP.StrictComparisons ?>
							<em><?php esc_attr_e( 'Tu comentario está esperando ser moderado.', 'Avada' ); ?></em>
							<br />
						<?php endif; ?>
						<?php comment_text(); ?>
					</div>
